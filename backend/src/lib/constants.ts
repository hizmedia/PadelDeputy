 ...
 * Admin CORS origins
 */
export const ADMIN_CORS = process.env.ADMIN_CORS || 'http://localhost:7001,http://localhost:9000';

/**
 * Auth CORS origins
 */
export const AUTH_CORS = process.env.AUTH_CORS || 'http://localhost:7001,http://localhost:9000';
